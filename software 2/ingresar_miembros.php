...
include("login_y_registro/ingreso_ciclista.php");
        ...
        <div id="contenido">
            <div class="registro-container">
                ...
                <form id="registro-ciclista" action="<?php  $_SERVER["PHP_SELF"];  ?>" method="POST">
                    ...
                    <button type="submit" class="registro-button" name="registrar-ciclista" id="registrar-ciclista">Registrar Ciclista</button>
                </form>
            </div>
        </div>
        <footer>
